...
const STARTER_QUESTIONS = [
  "Show me men's navy blue Tshirts",
  "I'm looking for a pink color kurta set for women",
  "Do you have unisex black leather sneakers ?",
  "Find me men's jacket in navy blue color",
];
